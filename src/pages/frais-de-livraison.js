...
const Livraison = () => {
  return (
    <>
      <Head>
        <title>Livraison - Safari</title>
        <meta
          name="description"
          content="Informations sur les options de livraison de Safari"
        />
      </Head>
          ...
          <div className="row">
            <div className="col-md-12">
              ...
              <p>
                ...
                Les frais de transport pour les achats inférieurs à Mille cinq
                cent (1500) Dirhams, sont à la charge du client. En cas de
                retard de livraison, vous bénéficiez de la possibilité d'annuler
                la commande dans les conditions de l'article 13 de la loi 31-08
                ...
                livraison possibles et les options qui s'offrent à vous. La
                société Safari import-export ne peut être tenue pour responsable
                de retard de livraison dû exclusivement à une indisponibilité du
                client après plusieurs propositions de rendez-vous.
              </p>
              ...
              <p>
                La livraison vous est offerte à partir de 1500 Dhs d’achat. Pour
                un montant d'achat inférieur à 1500 Dhs, les frais de livraison
